    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-lg mx-auto">
                ...
                @else action="{{ route('products.store') }}" @endif
                    ...
                    <div
                        ...
                        <div class="space-y-1 text-center">
                            @if ($product->id)<img class="w-10  rounded-full" src="{{ asset("$product->featured_image_url") }}" />@endif
                            <div class="flex text-sm text-gray-600">
                                ...
                                focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                    ...
                                    <input type="file" id="image" name="image" class="sr-only" required="" >
                                </label>
                            </div>
